					...
					if (!empty($_FILES)) {
						...
						switch(true):
							...
							case (!in_array($ext, $ext_toegestaan)):
								...
								break;
							//het bestand is groter dan 4 MB
							case ($_FILES['bestand']['size'] > $max_grootte):
								echo 'Het bestand moet kleiner zijn dan 4 MB.';
								break;
							...
							default:
								...
								if ($_FILES['bestand']['error'] === UPLOAD_ERR_PARTIAL) {
									echo 'Er ging iets fout bij het verzenden. Probeer het nog eens.';
								} else {
